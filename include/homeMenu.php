    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3 col-md-12 col-xs-12 mobile-center">
          <div class="blog-logo text-left"><a href="index.php"> <img src="img/shop-logo.png"  alt="logo"/></a></div>
        </div>
...
<div id="cd-nav"> <a href="#0" class="cd-nav-trigger">Menu<span></span></a>
  <nav id="cd-main-nav">
    <ul>
      <li class="active"><a href="index.php"><span>Home</span> <small>X-Sport Home Page</small> </a></li>
